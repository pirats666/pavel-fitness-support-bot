...
import { closeDb, createClient, deleteClient, getClient, listClients, updateClientField, logDatabaseDiagnostics, migrateStage1Schema, runStage1DbInsertTest } from './db.js';
...
void migrateStage1Schema().then(()=>process.env.DB_INSERT_TEST==='1'?runStage1DbInsertTest():undefined).then(()=>logDatabaseDiagnostics()).catch(e=>{console.error('[DB MIGRATION] Failed:',e);process.exit(1);});
