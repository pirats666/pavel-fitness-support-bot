...
import { migrateNextBaseTemplateSchema, migrateFollowingBaseTemplateSchema, migrateUpperLowerSpecializationTemplateSchema, migrateFullBodyUpperLowerTemplateSchema, migratePplSpecializationTemplateSchema } from './stage4-next-template.js';
